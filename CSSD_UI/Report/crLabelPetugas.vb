...
Public Class crLabelPetugas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CSSD_UI.crLabelPetugas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrLabelPetugas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crLabelPetugas = New crLabelPetugas()
        rpt.Site = Me.Site
        Return rpt
    End Function
