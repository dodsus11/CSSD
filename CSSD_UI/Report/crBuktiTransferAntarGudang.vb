...
Public Class crBuktiTransferAntarGudang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crBuktiTransferAntarGudang.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CSSD_UI.crBuktiTransferAntarGudang.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PetugasEntry() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrBuktiTransferAntarGudang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crBuktiTransferAntarGudang = New crBuktiTransferAntarGudang()
        rpt.Site = Me.Site
        Return rpt
    End Function
