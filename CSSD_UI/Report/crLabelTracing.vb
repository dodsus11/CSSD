...
Public Class crLabelTracing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CSSD_UI.crLabelTracing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrLabelTracing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crLabelTracing = New crLabelTracing()
        rpt.Site = Me.Site
        Return rpt
    End Function
