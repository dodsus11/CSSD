...
Public Class crBuktiDistRuangan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CSSD_UI.crBuktiDistRuangan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrBuktiDistRuangan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crBuktiDistRuangan = New crBuktiDistRuangan()
        rpt.Site = Me.Site
        Return rpt
    End Function
