...
Imports System.IO
Imports RockUtil
Public Class ucDistribusiRuangan
    ...
    Dim DEFAULT_GUDANG() As String = {"CSSD"}
    ...
    Private Sub btnLookupPasien_Click(sender As System.Object, e As System.EventArgs) Handles btnLookupPasien.Click
        ...
        'frmLookUp.fidArray = {{"mr_no", "No.RM", 100},
        '                        {"No_Register", "Register", 100},
        '                        {"nama_pasien", "nama", 200},
        '                      {"umur", "umur", 100},
        '                      {"poly_name", "ruang", 200}
        '                     }

        'frmLookUp.keyField = "No_Register"
        'frmLookUp.fields = {"mr_no", "No_Register", "nama_pasien", "umur", "poly_name"}

        'Me.cssdServ = InProcFactory.CreateChannel(Of CSSDOrderService, ICSSDOrderService)()

        'Dim dtPasien As New DataTable
        'dtPasien = Me.cssdServ.GetPasienMasihDirawat
        ...
        '    txtNoRM.Text = frmLookUp.returnRow("mr_no").ToString()
        '    txtNoRegister.Text = frmLookUp.returnRow("no_register").ToString()
        '    txtNamaPasien.Text = frmLookUp.returnRow("nama_pasien").ToString()
        '    txtUmur.Text = frmLookUp.returnRow("umur").ToString()
        '    txtRuang.Text = frmLookUp.returnRow("poly_name").ToString()

        'End If
    End Sub

    Private Sub ucDistribusiRuangan_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        txtKodeBarcode.Focus()
        txtPetugasKirim.Clear()
    ...
    Private Sub gridItem_CellContentClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles gridItem.CellContentClick
        ...
        '        dt = Me.cssdServ.GetReportBuktiOrder_label(gridItem.DataSource.rows(e.RowIndex).item(1))
        ...
        '            If frmLookUp.returnRow("NoOrder").ToString() <> gridItem.DataSource.rows(i).item(6) And gridItem.DataSource.rows(i).item(6) <> "" Then
    ...
    Private Sub btnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSimpan.Click
        If txtPetugasKirim.Text = String.Empty Then
            MessageBox.Show("Maaf nama petugas pengirim  harus diisi !", "Pesan", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Return
        End If
        If txtPetugasPenerima.Text = String.Empty Then
            MessageBox.Show("Maaf nama petugas penerima harus diisi !", "Pesan", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Return
        End If
        Me.SaveData()
    End Sub
    ...
    Private Sub SaveData()
        Try
            ...
            OrderAlatHeader.Status = "RUANGAN"
            OrderAlatHeader.UserPenerima = txtPetugasPenerima.Text
            OrderAlatHeader.PetugasSterilisasi = txtPetugasKirim.Tag
            ...
            Else
                ...
                '    CetakCekListDistribusi(1, item.NoTracing, headerData)
                'Next

                Dim rpt As New crBuktiDistRuangan
                Dim frm As New FrmPreview
    ...
    Private Sub BtnKeluar_Click(sender As System.Object, e As System.EventArgs) Handles BtnKeluar.Click
        'Me.Dispose()
        Dim uc As New ucDistribusiRuanganDaftar
    ...
    Private Sub btnPetugasSterilisasi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlookPetugasKirim.Click
        ...
        If frmLookUpPetugas.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            txtPetugasKirim.Tag = frmLookUpPetugas.returnRow("KodePetugas").ToString()
            txtPetugasKirim.Text = frmLookUpPetugas.returnRow("NamaPetugas").ToString()

        End If
    End Sub

    Private Sub txtKodeBarcode_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtKodeBarcode.TextChanged
